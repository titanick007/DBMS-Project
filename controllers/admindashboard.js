...
router.all('/soldpendings', function(req, res) {
    dashboardModel.mostSoldProducts(function(mostSoldResult) {
        dashboardModel.soldpendings(function(soldPendingsResult) {
            res.render('./admindashboard/soldpendings', {
                mostOrderedProducts: mostSoldResult,
                result: soldPendingsResult
            });
        });
    });
});
